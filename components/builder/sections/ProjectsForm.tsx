  ...
  return (
    <div className="card p-4 mb-3 space-y-3">
      <div className="flex justify-between items-center">
        <p className="text-sm font-medium text-foreground">{proj.name || 'New Project'}</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex flex-col gap-1 col-span-2">
          <label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Project URL (optional)</label>
      ...
      <div>
        <label className="text-xs font-medium text-muted-foreground uppercase tracking-wider block mb-2">Key Points</label>
...
export function ProjectsForm() {
  ...
  return (
    <div>
      ...
      <button onClick={handleAdd} className="w-full py-3 rounded-xl border-2 border-dashed border-border text-sm text-muted-foreground hover:border-teal-300 hover:text-teal-600 hover:bg-teal-50 dark:hover:bg-teal-400/10 transition-all flex items-center justify-center gap-2 mb-4">
