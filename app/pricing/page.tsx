      ...
      <section className="mx-auto max-w-7xl py-16">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-3">
          {pricingPlans.map((plan) => (
            <Card
              key={plan.name}
              className={`p-6 ${plan.featured ? 'border-indigo-200 bg-gradient-to-br from-white via-indigo-50 to-violet-50 ring-2 ring-indigo-500/20 dark:from-slate-900 dark:via-indigo-950/40 dark:to-violet-950/40' : ''}`}
            >
              ...
              <div className="mt-7 flex items-end gap-2">
                <span className="text-5xl font-bold tracking-tight text-slate-950 dark:text-white">{plan.price}</span>
